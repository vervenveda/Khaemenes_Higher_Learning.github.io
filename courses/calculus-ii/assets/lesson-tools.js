...
if(!id)return;
const KEY="khaemenes-calculus2-lesson-progress-v2";
...
$("#exportLesson")?.addEventListener("click",()=>{
  const payload={course:"Calculus II",lessonId:id,title:body.dataset.lessonTitle||document.title,unit:Number(body.dataset.unit),lesson:Number(body.dataset.lessonNumber),...rec};
