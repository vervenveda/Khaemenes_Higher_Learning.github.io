...
if(!id)return;
const KEY="khaemenes-differential-equations-lesson-progress-v1";
...
$("#exportLesson")?.addEventListener("click",()=>{
  const payload={course:"Differential Equations",lessonId:id,title:body.dataset.lessonTitle||document.title,unit:Number(body.dataset.unit),lesson:Number(body.dataset.lessonNumber),...rec};
