(() => {
"use strict";
const cfg=window.DISCRETE_MATHEMATICS_ASSESSMENT_CONFIG||{};
const all=cfg.source==="diagnostic"?window.DISCRETE_MATHEMATICS_DIAGNOSTIC:window.DISCRETE_MATHEMATICS_QUESTIONS;
const host=document.getElementById("assessmentRoot");
if(!host||!Array.isArray(all))return;
const KEY="khaemenes-discrete-mathematics-assessment-records-v1";
