...
if(!id)return;
const KEY="khaemenes-discrete-mathematics-lesson-progress-v1";
...
$("#exportLesson")?.addEventListener("click",()=>{
  const payload={course:"Discrete Mathematics",lessonId:id,title:body.dataset.lessonTitle||document.title,unit:Number(body.dataset.unit),lesson:Number(body.dataset.lessonNumber),...rec};
