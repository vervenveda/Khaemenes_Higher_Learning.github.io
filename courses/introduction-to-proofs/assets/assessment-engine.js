(() => {
"use strict";
const cfg=window.INTRODUCTION_TO_PROOFS_ASSESSMENT_CONFIG||{};
const all=cfg.source==="diagnostic"?window.INTRODUCTION_TO_PROOFS_DIAGNOSTIC:window.INTRODUCTION_TO_PROOFS_QUESTIONS;
const host=document.getElementById("assessmentRoot");
if(!host||!Array.isArray(all))return;
const KEY="khaemenes-introduction-to-proofs-assessment-v1";
...
function start(){
 ...
 const token=`introduction-to-proofs-${Date.now()}`;
