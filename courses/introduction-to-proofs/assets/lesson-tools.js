...
if(!id)return;
const KEY="khaemenes-introduction-to-proofs-lessons-v1";
...
$("#exportLesson")?.addEventListener("click",()=>{
  const payload={course:"Introduction to Proofs",lessonId:id,title:body.dataset.lessonTitle||document.title,unit:Number(body.dataset.unit),lesson:Number(body.dataset.lessonNumber),...rec};
