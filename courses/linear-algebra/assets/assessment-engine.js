(() => {
"use strict";
const cfg=window.LINEAR_ALGEBRA_ASSESSMENT_CONFIG||{};
const all=cfg.source==="diagnostic"?window.LINEAR_ALGEBRA_DIAGNOSTIC:window.LINEAR_ALGEBRA_QUESTIONS;
const host=document.getElementById("assessmentRoot");
if(!host||!Array.isArray(all))return;
const KEY="khaemenes-linear-algebra-assessment-records-v1";
