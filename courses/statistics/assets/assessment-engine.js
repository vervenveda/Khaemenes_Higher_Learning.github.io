(() => {
"use strict";
const cfg=window.STATISTICS_ASSESSMENT_CONFIG||{};
const all=cfg.source==="diagnostic"?window.STATISTICS_DIAGNOSTIC:window.STATISTICS_QUESTIONS;
const host=document.getElementById("assessmentRoot");
if(!host||!Array.isArray(all))return;
const KEY="khaemenes-statistics-assessment-records-v1";
