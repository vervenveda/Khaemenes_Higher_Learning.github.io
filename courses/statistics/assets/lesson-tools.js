...
if(!id)return;
const KEY="khaemenes-statistics-lesson-progress-v1";
...
$("#exportLesson")?.addEventListener("click",()=>{
  const payload={course:"Statistics",lessonId:id,title:body.dataset.lessonTitle||document.title,unit:Number(body.dataset.unit),lesson:Number(body.dataset.lessonNumber),...rec};
